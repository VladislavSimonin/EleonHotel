...
{
    public partial class CleaningPayment : Window
    {
        ...
        public CleaningPayment(int userId, int serviceId, string serviceName, decimal serviceCost)
        {
            InitializeComponent();
            _userId = userId;
        ...
        private async void BtnPay_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show(
                        $"Оплата прошла успешно! Горничная придет в Ваш номер в ближайшее время.\n\nСумма оплаты: {_serviceCost:#,##0} ₽\nУслуга \"{_serviceName}\" заказана.",
                        "Успешная оплата",
                        MessageBoxButton.OK,
